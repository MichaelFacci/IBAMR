...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        MeshTools::Generation::build_line(solid_mesh, num_elems, -1, 1, Utility::string_to_enum<ElemType>(elem_type));
        ...
        //double theta = M_PI/2; //rotate 90 degrees, perpendicular to flow
        ...
        */
        ...
        if (NDIM == 2 && (elem_type == "TRI3" || elem_type == "TRI6"))
        {
            ...
            for (int k = 0; k < num_circum_nodes; ++k)
            {
                ...
                solid_mesh.add_point(libMesh::Point(2.5 + R * cos(theta),1.0 + R * sin(theta)));
            }
            TriangleInterface triangle(solid_mesh);
            triangle.triangulation_type() = TriangleInterface::GENERATE_CONVEX_HULL;
            triangle.elem_type() = Utility::string_to_enum<ElemType>(elem_type);
